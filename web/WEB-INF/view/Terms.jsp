<%-- 
    Document   : Terms
    Created on : 15-Jan-2015, 15:25:16
    Author     : gary
--%>
...
<p>[This website uses cookies. By using this website and agreeing to these terms and conditions, you consent to our [NAME]'s use of cookies in accordance with the terms of [NAME]'s [privacy policy / cookies policy].]</p>
...
<p>&bull; republish material from this website (including republication on another website);<br />
&bull; sell, rent or sub-license material from the website;<br />
&bull; show any material from the website in public;<br />
&bull; reproduce, duplicate, copy or otherwise exploit material on this website for a commercial purpose;]<br />
&bull; [edit or otherwise modify any material on the website; or]<br />
&bull; [redistribute material from this website [except for content specifically and expressly made available for redistribution].]</p>
...
<p>This website is provided &ldquo;as is&rdquo; without any representations or warranties, express or implied. [NAME] makes no representations or warranties in relation to this website or the information and materials provided on this website. </p>
...
<p>&#61548; death or personal injury caused by [NAME'S] negligence;<br />
&#61548; fraud or fraudulent misrepresentation on the part of [NAME]; or<br />
...
<p>[[NAME] is registered with [PROFESSIONAL BODY]. [NAME'S] professional title is [TITLE] and it has been granted in the United Kingdom. [NAME] is subject to the [RULES] which can be found at [URL].]</p>
